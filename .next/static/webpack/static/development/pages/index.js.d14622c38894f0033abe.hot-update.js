    ...
    value: function componentWillMount() {
      ...
      db.collection("provinces").get().then(function (querySnapshot) {
        querySnapshot.forEach(function (doc) {
          var province = doc.data().name;

          _this2.state.provinces.push(province);

          console.log(_this2.state.provinces);

          _this2.setState({
            provinces: _this2.state.provinces
          });
        });
      });
    }
...
//# sourceMappingURL=index.js.d14622c38894f0033abe.hot-update.js.map